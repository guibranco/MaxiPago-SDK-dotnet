...
namespace MaxiPago.Tests.Gateway
{
    public class ApiGatewayTests
    {
        ...
        {
            _utils.SendRequest(Arg.Any<ApiRequest>(), Arg.Any<string>()).Returns(new ApiResponse());
            ...
            _utils
                .Received(1)
                .SendRequest(Arg.Is<ApiRequest>(r => r.Command == "add-consumer"), "TEST");
        }
        ...
        public void AddConsumer_ReturnsApiResponse()
        {
            ...
            _utils.SendRequest(Arg.Any<ApiRequest>(), Arg.Any<string>()).Returns(expected);
        ...
        public void DeleteConsumer_SendsDeleteConsumerCommand_WithCustomerId()
        {
            ...
            _utils
                ...
                .SendRequest(
                    Arg.Is<ApiRequest>(r =>
                        r.Command == "delete-consumer" && r.CommandRequest.CustomerId == customerId
                    ),
                    "TEST"
                );
        }
        ...
        public void UpdateConsumer_SendsUpdateConsumerCommand()
        {
            ...
            _utils
                ...
                .SendRequest(
                    Arg.Is<ApiRequest>(r =>
                        r.Command == "update-consumer" && r.CommandRequest.CustomerId == customerId
                    ),
                    "TEST"
                );
        }
        ...
        public void CancelRecurring_SendsCancelRecurringCommand()
        {
            ...
            _utils
                ...
                .SendRequest(
                    Arg.Is<ApiRequest>(r =>
                        r.Command == "cancel-recurring" && r.CommandRequest.OrderID == orderId
                    ),
                    "TEST"
                );
        }
