...
namespace MaxiPago.Tests.Gateway
{
    public class TransactionGatewayTests
    {
        ...
        private void SetupTransactionResponse() =>
            _utils.SendRequest(Arg.Any<TransactionRequest>(), Arg.Any<string>())
        ...
        public void Sale_Basic_SendsSaleOperation()
        {
            ...
            _transaction.Sale(
                MerchantId(), MerchantKey(), referenceNum, chargeTotal,
                CardNumber(), "12", "2030", "1", "123", null,
                ProcessorId(), "1", null, IpAddress(), null,
                "BRL", null, null, null
            );
        ...
        public void Sale_WithInstallments_SetsCreditInstallment()
        {
            ...
            _transaction.Sale(
                MerchantId(), MerchantKey(), ReferenceNum(), ChargeTotal(),
                CardNumber(), "12", "2030", "1", "123", null,
                ProcessorId(), "3", "Y", IpAddress(), null,
                "BRL", null, null, null
            );
        ...
        public void Sale_WithSingleInstallment_DoesNotSetCreditInstallment()
        {
            ...
            _transaction.Sale(
                MerchantId(), MerchantKey(), ReferenceNum(), ChargeTotal(),
                CardNumber(), "12", "2030", "1", "123", null,
                ProcessorId(), "1", "Y", IpAddress(), null,
                "BRL", null, null, null
            );
        ...
        public void Sale_WithBillingShipping_PopulatesBillingAddress()
        {
            ...
            _transaction.Sale(
                ...
                CardNumber(), "12", "2030", "1", "123", null,
                ProcessorId(), "1", null, IpAddress(), null,
                billingName, Faker.Address.StreetAddress(), null,
                billingCity, Faker.Address.StateAbbr(), Faker.Address.ZipCode(), "BR",
                Faker.Phone.PhoneNumber(), Faker.Internet.Email(),
                Faker.Person.FullName, Faker.Address.StreetAddress(), null,
                Faker.Address.City(), Faker.Address.StateAbbr(), Faker.Address.ZipCode(), "BR",
                Faker.Phone.PhoneNumber(), Faker.Internet.Email(),
                "BRL", null, null, null
            );
        ...
        public void Sale_WithBillingShipping_PopulatesShippingAddress()
        {
            ...
            _transaction.Sale(
                ...
                Faker.Address.City(), Faker.Address.StateAbbr(), Faker.Address.ZipCode(), "BR",
                Faker.Phone.PhoneNumber(), Faker.Internet.Email(),
                shippingName, Faker.Address.StreetAddress(), null,
                Faker.Address.City(), Faker.Address.StateAbbr(), Faker.Address.ZipCode(), "BR",
                Faker.Phone.PhoneNumber(), Faker.Internet.Email(),
                "BRL", null, null, null
            );
            ...
            _utils.Received(1).SendRequest(
                Arg.Is<TransactionRequest>(r =>
                    r.Order.Sale.Shipping != null &&
                    r.Order.Sale.Shipping.Name == shippingName),
                Arg.Any<string>()
            );
        }
        ...
        public void Sale_WithToken_SetsOnFilePayType()
        {
            ...
            _transaction.Sale(
                MerchantId(), MerchantKey(), ReferenceNum(), ChargeTotal(),
                ProcessorId(), token, customerId,
                "1", null, IpAddress(), "BRL", null, null, null
            );
        ...
        public void Auth_Basic_SendsAuthOperation()
        {
            ...
            _utils.Received(1).SendRequest(
                Arg.Is<TransactionRequest>(r =>
                    r.Order.Auth != null &&
                    r.Order.Auth.ReferenceNum == referenceNum),
                "TEST"
            );
        }
        ...
        public void Capture_ReturnsResponse()
        {
            ...
            var result = _transaction.Capture(
                ...
                Faker.Random.AlphaNumeric(12), ReferenceNum(), ChargeTotal()
            );
        ...
        public void Boleto_SetsBoletoPayType()
        {
            ...
            _transaction.Boleto(
                MerchantId(), MerchantKey(), ReferenceNum(), ChargeTotal(),
                ProcessorId(), IpAddress(), null,
                expirationDate, boletoNumber, "Pay at any bank",
                Faker.Person.FullName, Faker.Address.StreetAddress(), null,
            ...
            _utils.Received(1).SendRequest(
                Arg.Is<TransactionRequest>(r =>
                    ...
                    r.Order.Sale.TransactionDetail.PayType.Boleto.ExpirationDate == expirationDate &&
        ...
        public void Boleto_PopulatesBillingInfo()
        {
            ...
            _transaction.Boleto(
                MerchantId(), MerchantKey(), ReferenceNum(), ChargeTotal(),
                ProcessorId(), IpAddress(), null,
                "2030-12-31", Faker.Random.AlphaNumeric(10), "Pay at any bank",
                billingName, Faker.Address.StreetAddress(), null,
                Faker.Address.City(), Faker.Address.StateAbbr(),
                Faker.Address.ZipCode(), "BR",
                Faker.Phone.PhoneNumber(), Faker.Internet.Email()
        ...
        public void Recurring_WithCreditCard_SetsCreditCardPayType()
        {
            ...
            _transaction.Recurring(
                MerchantId(), MerchantKey(), ReferenceNum(), ChargeTotal(),
                cardNumber, "12", "2030", "1", "123",
                ProcessorId(), "1", null, IpAddress(),
                "new", "2024-01-01", "1", "monthly", "12", "3", "BRL"
            );
            ...
            _utils.Received(1).SendRequest(
                Arg.Is<TransactionRequest>(r =>
                    ...
                    r.Order.RecurringPayment.TransactionDetail.PayType.CreditCard.Number == cardNumber),
                Arg.Any<string>()
            );
        }
        ...
        public void Recurring_WithToken_SetsOnFilePayType()
        {
            ...
            _utils.Received(1).SendRequest(
                Arg.Is<TransactionRequest>(r =>
                    ...
                    r.Order.RecurringPayment.TransactionDetail.PayType.OnFile.CustomerId == customerId &&
        ...
        public void OnlineDebit_SetsOnlineDebitPayType()
        {
            ...
            _transaction.OnlineDebit(
                MerchantId(), MerchantKey(), ReferenceNum(), ChargeTotal(),
                ProcessorId(), parametersUrl, IpAddress(), null
            );

            _utils.Received(1).SendRequest(
                Arg.Is<TransactionRequest>(r =>
                    r.Order.Sale.TransactionDetail.PayType.OnlineDebit != null &&
                    r.Order.Sale.TransactionDetail.PayType.OnlineDebit.ParametersURL == parametersUrl),
                Arg.Any<string>()
            );
        }
        ...
        public void OnlineDebit_WithNullParametersUrl_UsesEmptyString()
        {
            ...
            _transaction.OnlineDebit(
                MerchantId(), MerchantKey(), ReferenceNum(), ChargeTotal(),
                ProcessorId(), null, IpAddress(), null
            );

            _utils.Received(1).SendRequest(
                Arg.Is<TransactionRequest>(r =>
                    r.Order.Sale.TransactionDetail.PayType.OnlineDebit.ParametersURL == string.Empty),
                Arg.Any<string>()
            );
        }
        ...
        public void AllMethods_UseConfiguredEnvironment()
        {
            ...
            _transaction.Void(MerchantId(), MerchantKey(), Faker.Random.AlphaNumeric(15), IpAddress());
